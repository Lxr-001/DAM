...
public interface ISysUserService extends IService<SysUser> {
	 ...
	 * @return log_type
	 */
	int getLogTypeByUserName(String username);
	...
	/**
	 * 根据 OrgunitIds查询，查询用户所属部门的名称（多个部门名逗号隔开）
	 *
	 * @param OrgunitIds
	 * @return
	 */
	 ...
	 * @param departs 选择的部门id，多个以逗号隔开
	 */
	void editUserNew(SysUser user, String roles, String departs);
	...
	LoginUser getEncodeUserInfo1(String username);
}
