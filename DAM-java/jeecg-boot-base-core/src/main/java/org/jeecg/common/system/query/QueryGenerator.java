...
public class QueryGenerator {
     ...
     * @param systemSecurity 系统密级
     * @param <T>            实体类型
     * @return 应用了密级筛选的查询包装器
     */
    public static <T> QueryWrapper<T> applySecretLevelFilter(QueryWrapper<T> queryWrapper, Integer systemSecurity) {
        // 获取当前用户
        ...
        if (user != null) {
            ...
            // 应用密级筛选条件
            queryWrapper.le("secret_level", secretLevel);
        }
        return queryWrapper;
    }
		...
		*/
        ...
        for (int i = 0; i < origDescriptors.length; i++) {
            ...
            try {
                ...
                } else if ("security".equals(column) && null != value) { //限制用户密级
    ...
    public static void doMultiFieldsOrder(QueryWrapper<?> queryWrapper, Map<String, String[]> parameterMap, Map<String, String> fieldColumnMap) {
     ...
     */
    public static Object parseByType(String value, String type, QueryRuleEnum rule) throws ParseException {
        Object temp;
        switch (type) {
