    ...
    computed: {
      getValueSting(){
        ...
        if(this.dictCode == 'system_security'){
          if(this.value && (this.maxLevel !== 0) && (this.value > this.maxLevel)){
            return this.maxLevel.toString();
          }
        }
...
//                console.log(res.result);
            ...
            if(this.dictCode==="system_security" && this.maxLevel !== 0){
      ...
      setMaxLevel(maxLevel){
        if(maxLevel){
          console.log("this.dictOptions.filter(e => e.value <= maxLevel):",this.dictOptions.filter(e => e.value <= maxLevel));
          this.dictOptions=this.dictOptions.filter(e => e.value <= maxLevel);
        }
      },
      handleInput(e='') {
        let val;
