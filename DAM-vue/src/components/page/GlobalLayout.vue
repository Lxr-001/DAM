  ...
  <a-layout class="layout" :class="[device]">
    ...
    >
      ...
      <a-layout-content :style="{ height: '100%', paddingTop: fixedHeader ? '59px' : '0' }">
        <slot></slot>
<!--        &lt;!&ndash; 左侧20% 全局固定区域（所有页面共享） &ndash;&gt;-->
<!--        <div class="global-left-column">-->
<!--          &lt;!&ndash; 左侧内容：可放入图片中的"基础信息管理"等菜单，或自定义内容 defaultSelectedKeys="['home']" &ndash;&gt;-->
...
<!--        &lt;!&ndash; 右侧80% 页面内容区（承载所有页面/tab内容） &ndash;&gt;-->
<!--        <div class="global-right-column">-->
<!--          <slot></slot> &lt;!&ndash; 所有页面内容（首页、新tab页等）都会渲染到这里 &ndash;&gt;-->
<!--        </div>-->
      </a-layout-content>
...
export default {
  ...
  mixins: [mixin, mixinDevice, TreeMixin],
  data() {
    return {
      collapsed: false,
      activeMenu: {},
...
.global-left-column {
  width: 20% !important;
  min-width: 20% !important; /* 固定20%宽度，不被压缩 */
  background: #fff;
  border-right: 1px solid #e8e8e8; /* 分隔线，可选 */
  padding: 16px;
  box-sizing: border-box;
  height: calc(100vh - 59px) !important; /* 高度 = 屏幕高度 - 顶部导航栏高度 */
  position: fixed; /* 固定左侧，滚动不跟随 */
  top: 59px; /* 与顶部导航栏对齐 */
  overflow-y: auto; /* 左侧内容过多时可滚动 */
}

.global-right-column {
  width: 80% !important;
  margin-left: 20% !important; /* 让出左侧20%空间 */
  padding: 24px;
  box-sizing: border-box;
  min-height: calc(100vh - 59px) !important;
}

// 响应式适配：移动端隐藏全局左侧栏（使用原有抽屉菜单）
